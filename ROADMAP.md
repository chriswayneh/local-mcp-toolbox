...
## Phase 1 — Discovery and Architecture (current)
...
- [ ] Review architecture before core implementation

## Version 1.0 — Secure Read-Only Core

- [ ] Typed settings, permission service, redaction, audit records, contracts, and safe errors
